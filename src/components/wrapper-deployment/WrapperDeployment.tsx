    ...
    <div>
      {
        wrapper && (
          <>
            <PublishToIpfs wrapper={wrapper} setWrapper={setWrapper} ipfsNode={ipfsNode}></PublishToIpfs>
            <PublishToEns wrapper={wrapper} setWrapper={setWrapper}></PublishToEns>
            <PublishToWns wrapper={wrapper} setWrapper={setWrapper}></PublishToWns>
            <PublishToOcr wrapper={wrapper} setWrapper={setWrapper}></PublishToOcr>
          </>
        )
      }
    </div>
