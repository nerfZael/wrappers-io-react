...
const getCanIpfsPublish = (chainId: number | undefined, wrapper: LoadedWrapper): boolean => {
  ...
  return (
    <div className="PublishToIpfs">
      <div className="registry-section ipfs">
        {
          !wrapper.cid && (
            <button className="btn btn-success" disabled={!canIpfsPublish} onClick={async (e) =>{
                publishToIpfs();
                e.preventDefault();
                e.stopPropagation();
              }
